...
const filepath=req.query.text4;
    ...
    for (const phoneNumber of numbersArray) {
      ...
      // await element.click();
        ...
        if (value === "OK") {
          ...
          const localImagePath = 'C:\\Users\\HP\\Desktop\\video.mp4';
        
          await driver.manage().setTimeouts({ implicit: 5000 });
          const attach= driver.findElement(By.xpath("//div[@title='Attach']"));
          await attach.click();
          await sleep(1000);
          driver.findElement(By.xpath("//input[@accept='image/*,video/mp4,video/3gpp,video/quicktime']")).sendKeys(filepath);
